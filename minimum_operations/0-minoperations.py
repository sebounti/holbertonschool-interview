...
def minOperations(n):
    ...
    The function works by finding the smallest factor of 'n' (other than 1) and then
    recursively applying the same logic to the quotient of 'n' divided by this factor.
    ...
    if n <= 1:
        ...
        # In case n is a prime number, it requires n operations (one 'Copy All' and n-1 'Pastes')
        return n
